...
class ChatBotFactory
{
    ...
    public static function create(
        ...
        return new ChatBot($thread, $user, $cache, $driver, $config, $storageDriver);
    }

    /**
     * Create a new ChatBot instance that listens on a socket.
     *
     * @param array $config
    ...
    public static function createForSocket(
        ...
        $botman = new ChatBot($cache, DriverManager::loadFromName('Null', $config), $config, $storageDriver);
